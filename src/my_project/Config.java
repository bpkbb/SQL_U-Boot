...
public class Config {
    ...
    public final static String WINDOW_TITLE = "U-Boote in Sicht!!!!!!!!";
    ...
    public final static int WINDOW_WIDTH = 1170;
    public final static int WINDOW_HEIGHT = 610+29;   // Effektive Höhe ist etwa 29 Pixel geringer (Titelleiste wird mitgezählt)
